...
<div className="flex max-md:flex-col flex-wrap
   justify-between gap-5 sm:px-16 px-6 py-10">
    <div className="flex flex-col justify-start items-start gap-6">
        ...
        <p>MechStore
     <Image src="/logo.PNG" alt="logo" width={118}
     height={18} className="object-contain"/>
      </p>
     <p className="text-base text-gray-700">MechStore 2024 ,<br />
    ...
    border-gray-100 sm:px-16 px-6 py-10">
        <p>@2024 MechStore ALL RIGHTS RESERVED</p>
